...
exports.Payment = exports.Enrollment = void 0;
...
const enrollmentConnection = getExternalConnection(process.env.ENROLLMENT_MONGO_URI || "mongodb://localhost:27017/enrollment-db");
...
exports.Enrollment = enrollmentConnection.models.Enrollment ||
    enrollmentConnection.model("Enrollment", EnrollmentSchema);
exports.Payment = paymentConnection.models.Payment ||
